ActiveAdmin.register Customer do
  ...
  #
  # permit_params do
  #   permitted = [:contact, :street_address, :city, :state, :email, :encrypted_password, :reset_password_token, :reset_password_sent_at, :remember_created_at, :first_name, :last_name]
